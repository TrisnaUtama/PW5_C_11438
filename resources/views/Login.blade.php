...
<html lang="en">
    ...
    <body class="antialiased">
        ...
        <section class="background-radial-gradient overflow-hidden">
            <div class="px-md-5 text-lg-start container my-5 px-4 py-5 text-center">
                <div class="row gx-lg-5 align-items-center mb-5">
                    <div class="col-lg-6 mb-lg-0 mb-5" style="z-index: 10">
                        <h1 class="display-5 fw-bold ls-tight my-5" style="color: hsl(218, 81%, 95%)">
                            Gofit Indonesia<br/>
                            <span style="color: hsl(218, 81%, 75%)">Make Your Body Perfect</span>
                        </h1>
                        <p class="justify-content-center mb-4 opacity-70"
